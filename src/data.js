...
const data = [
  {
    ...
    img: "/images/Converting Your React Vite App into PWA.webp",
  ...
  },
  {
    ...
    img: "/images/orange fixbox change password & Wi-Fi name.webp",
  ...
  },
  {
    ...
    img: "/images/create ovhcloud professional email.webp",
  ...
  },
  {
    ...
    content: `
      <p>The solution </p>
      <ul>
      <li>1) THe plugin/theme you installed : try to disable them one to one and see if the error remains</li>
      <li>2) Make PHP version : 8 or more  & PHP memory limit : 256M or more</li>
      <li>3) install plugin "Health Check & Troubleshooting added"</li>
  ...
  },
  {
    ...
    img: "/images/Les-fonction-logiques.webp",
